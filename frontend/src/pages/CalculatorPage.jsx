  ...
  return (
    <ContentContainer breadcrumbItems={['Other Tools', 'CPR and Camarilla Calculator']}>
      ...
      <p>
        ...
        <br />
        <i>
          Example: if you want to calculate the current weekly CPR/Camarilla levels yo should input the High, Low and
          Close values of the previous weekly candle.
        </i>
      </p>
        ...
        <Space>
          <Space direction='vertical'>
            ...
            <InputNumber
              ...
              min='0'
              value={state.high}
              onChange={(value) => setState((prevState) => ({ ...prevState, high: value }))}
            />
          </Space>
          <Space direction='vertical'>
            Low:
            <InputNumber
              ...
              min='0'
              value={state.low}
              onChange={(value) => setState((prevState) => ({ ...prevState, low: value }))}
            />
          </Space>
          <Space direction='vertical'>
            Close:
            <InputNumber
              ...
              min='0'
              value={state.close}
              onChange={(value) => setState((prevState) => ({ ...prevState, close: value }))}
            />
          </Space>
        </Space>
