import Exchange, { timeframes } from 'exchanges/Exchange';
import ExchangeEnum from 'data/ExchangeEnum';
import MarketEnum from 'data/MarketEnum';
import axios from 'axios';
import * as BinanceHelper from 'exchanges/binance/BinanceHelper';
import ICandlesticks from 'data/ICandlesticks';
import { ITimeframe } from 'exchanges/Exchange';
